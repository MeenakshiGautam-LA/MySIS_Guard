...
public final class ViewfinderView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        screenHeight = getDisplayMetrics().heightPixels / 2;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int topOffset = (screenHeight - frameHeight) + getPaddingTop() - getPaddingBottom();
//        frame = new Rect(leftOffset, topOffset, leftOffset + frameWidth, topOffset + frameHeight);
        frame = new Rect(100, topOffset - 100, screenWidth - 100, screenHeight + 100);
    }
