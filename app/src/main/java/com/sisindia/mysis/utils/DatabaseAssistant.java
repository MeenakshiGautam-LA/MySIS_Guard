...
public class DatabaseAssistant {
    private static final String EXPORT_FILE_NAME = "/sdcard/DatabaseBackup/export.xml";
    ...
    public void exportData() {
        ...
        try {
            ...
            Log.e("dbCOUNT", "show tables, cur size " + cur.getCount());
            cur.moveToFirst();

            String tableName;
            while (cur.getPosition() < cur.getCount()) {
                tableName = cur.getString(cur.getColumnIndex("name"));
                Log.e("tableCloumnname ","" + tableName);

                // don't process these two tables since they are used
                // for metadata
                if (!tableName.equals("android_metadata") &&
                        !tableName.equals("sqlite_sequence") &&
                        !tableName.contains("sqlite_autoindex")&&
                !tableName.contains("room_master_table")) {
    ...
    private void exportTable(String tableName) throws IOException {
        ...
        Log.e("Startexportingtable ","" + tableName);
    ...
    class Exporter {
        ...
        public void addColumn(String name, String val) throws IOException {
            if (val != null && val.contains("&")) {
                String stg = START_COL + name + CLOSING_WITH_TICK + val.replaceAll("&", "&amp;") + END_COL;
                _bos.write(stg.getBytes());
            } else {
